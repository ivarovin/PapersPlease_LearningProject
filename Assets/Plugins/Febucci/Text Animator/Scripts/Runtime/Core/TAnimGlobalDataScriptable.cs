...
namespace Febucci.UI.Core
{
    ...
    public class TAnimGlobalDataScriptable : ScriptableObject
    {
        ...
        [SerializeField] internal TAnimBuilder.TagFormatting tagInfo_behaviors = new TAnimBuilder.TagFormatting('<', '>');
        [SerializeField] internal TAnimBuilder.TagFormatting tagInfo_appearances = new TAnimBuilder.TagFormatting('{', '}');
    }
